...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for node in orm['main.SongCommentNode'].objects.filter(song__isnull=True):
            node.version = self.root_node(node).projectversion_set.all()[0]
            node.save()
    ...
    models = {
        ...
        'main.tempfile': {
            ...
            'death_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 26, 1, 54, 38, 534758)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
